                                ...
                                @foreach ($themes as $theme)
                                    <label class="block cursor-pointer">
                                        <input type="radio" name="theme_id" value="{{ $theme->id }}"
                                            class="hidden peer"
                                            {{ $invitation->theme_id == $theme->id ? 'checked' : '' }} required>
                                        <div
                                ...
                                <div class="p-6 border rounded-lg">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="datetime-local" name="akad_date" id="akad_date"
                                            value="{{ \Carbon\Carbon::parse($invitation->akad_date)->format('Y-m-d\TH:i') }}"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="akad_address" id="akad_address" rows="3"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">{{ old('akad_address', $invitation->akad_address) }}</textarea>
                                    </div>
                                </div>
                                <div class="p-6 border rounded-lg">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="datetime-local" name="reception_date" id="reception_date"
                                            value="{{ \Carbon\Carbon::parse($invitation->reception_date)->format('Y-m-d\TH:i') }}"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="reception_location" id="reception_location"
                                            value="{{ old('reception_location', $invitation->reception_location) }}"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" required>
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <textarea name="reception_address" id="reception_address" rows="3"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">{{ old('reception_address', $invitation->reception_address) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
